---
title: "The Synthesis Problem: Why AI Makes You Smarter and Dumber at the Same Time"
description: "AI is the greatest divergent thinking tool ever built. But convergent thinking — synthesizing options into decisions — is still 100% human. That's the new bottleneck."
date: 2026-03-31
tags:
  - post
  - ai
...
1. **Time-limiting.** "I give myself 20 minutes and whatever I have, I go with."
2. **Source-limiting.** "I only let AI generate 3-5 options."
...
1. **Define evaluation criteria before you prompt.** Before asking AI for options, write down what you're optimizing for. Cost? Speed? Quality? Brand alignment? Strategic fit? The criteria should exist before the options do.

2. **Limit the holding, not the generating.** Let AI generate 30 options. Then use a structured framework — a decision matrix, a scoring rubric, a comparison table — to evaluate them. Don't try to hold the comparison in your head. Externalize it.

3. **Build synthesis into your AI system.** If you're designing agents, give them evaluation frameworks, not just generation capabilities. An agent that produces 10 options and ranks them against your stated criteria is more valuable than an agent that produces 50 options and leaves the ranking to you.
...
**The Synthesis Problem is the bottleneck. Cognitive architecture is the fix.** [Connected Intelligence on Skool](https://skool.com/connected-intelligence) teaches you how to build a system that doesn't just generate options — it structures the convergence so you make better decisions, faster. Architecture for the thinking that matters most.
